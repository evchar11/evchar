...
public interface IOrderService {
	 ...
	 *            设备号
	 * @param force
	 *            是否强制预约（不校验是否满足DEFAULT_MONEY_WARN_LIMIT）
	 * @return 订单号
	 */
	Long appoint(String wechatId, Long deviceId, Long carId, String macId,
			boolean force);
	 ...
	 * @param carId
	 */
	void deviceMatchUser(String wechatId, Long deviceId, String macId,
			Long carId);
	 ...
	 * @return
	 */
	PageResult<Order> findOrderPage(
	...
	Map<String, String> getConRecordsByMonth(String wechatId, String year);

...
public enum DataType {
	READ_SN(1), READ_MODEL(2), READ_PHERI(3), READ_IP(4), READ_PORT(5), READ_BATTERY(
			...
			0x17), UPLOAD_SN(0x81), UPLOAD_MODEL(0x82), UPLOAD_PHERI(0x83), UPLOAD_SERVER_IP(
			0x84), UPLOAD_SERVER_PORT(0x85), UPLOAD_POWER(0x86), UPLOAD_STATE(
			0x87), UPLOAD_BOOT_COMPLETED(0x88), UPLOAD_BATTERY(0x89);
